...
//dont know whether this event-bus is added or not
...
function onDeleteConfirm() {
    //modified to folder.data.id even when it is folder.id in the video
    deleteFilesForm.parent_id = page.props.folder.data.id;
